...
export function AllFacultyReportsView({
  ...
  const handleView = (report: EventReport) => {
    ...
    setIsViewOpen(false); // unused, kept for compatibility
      ...
      {selectedReport ? (
        ...
        <div className="bg-white">
          ...
          {selectedReport.thumbnailUrl ? (
            ...
            <div className="w-full h-80 bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center">
          ...
          <div className="p-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6 pb-6 border-b border-gray-200">
              ...
              <Badge
                className={`text-xs ${getStatusColor(selectedReport.status)}`}
              >
              ...
              <div className="flex items-center gap-3 mb-8 pb-6 border-b border-gray-100">
                ...
                <div>
                  <p className="font-medium text-gray-900">
                    By {selectedReport.facultyCoordinator}
                  </p>
            ...
            {selectedReport.adminRemarks && (
              <section className="mb-8 border-t pt-6">
                <h2 className="flex items-center gap-2 text-2xl font-bold text-gray-900 mb-3">
