...
function SignUpForm({ onSignUpSuccess, onSwitchToSignIn }) {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!formData.email || !formData.password || !formData.confirmPassword || !formData.fullName || !formData.department) {
...
_s(SignUpForm, "MMGjiaoineRPFbwRi2XdYoyYf+M=");
_c = SignUpForm;
var _c;
...
//# sourceMappingURL=src_dac084a7._.js.map