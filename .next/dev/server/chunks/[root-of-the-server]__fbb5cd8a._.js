...
"[project]/src/app/api/admin/diagnosis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let collections = [];
        try {
            const collectionsSnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].listCollections();
        ...
        try {
            const usersSnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("users").get();
        ...
        try {
            let pageToken;
            let authSnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].app?.auth()?.listUsers(1000, pageToken);
            if (authSnapshot) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbb5cd8a._.js.map