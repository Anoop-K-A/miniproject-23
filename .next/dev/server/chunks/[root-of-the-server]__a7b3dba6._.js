...
async function POST() {
    try {
        ...
        const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$engagements$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recomputeAllEngagements"])();
        ...
        const message = error instanceof Error ? error.message : "Unknown recomputation error";
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Failed to recompute engagement scores",
            message
        }, {
            status: 500
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a7b3dba6._.js.map