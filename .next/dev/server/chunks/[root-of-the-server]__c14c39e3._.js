...
async function POST(request) {
    try {
        ...
        try {
            const existingUserQuery = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("users").where("email", "==", email).limit(1).get();
            ...
            console.warn("Could not check user existence in Firestore:", firestoreCheckError.message);
        // Continue anyway - we'll try to create the user and Firestore write will fail if user exists
        }
        ...
        // Store user data in Firestore with approval status
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection("users").doc(userRecord.uid).set({
                uid: userRecord.uid,
                email,
                name: fullName,
                displayName: fullName,
            ...
            // If Firestore fails, still return success since the user was created in Auth
            // The user can be added to Firestore manually or via admin panel
            console.warn("Continuing with registration despite Firestore error");
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c14c39e3._.js.map