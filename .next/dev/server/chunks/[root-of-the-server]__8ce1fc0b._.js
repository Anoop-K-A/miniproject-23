...
"[project]/src/app/api/event-reports/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        const updatedReports = reports.map((report)=>report.id === id ? {
                ...report,
                ...payload,
                responseDate: payload.facultyResponse ? new Date().toISOString().split("T")[0] : report.responseDate,
                updatedAt
            } : report);
...
async function DELETE(_request, { params }) {
    try {
        ...
        const updatedAudits = audits.filter((audit)=>!(audit.entityType === "event-report" && audit.entityId === id));
        const updatedRemarks = remarks.filter((remark)=>!(remark.entityType === "event-report" && remark.entityId === id));
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jsonDb$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeJsonFile"])("eventReports.json", updatedReports);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8ce1fc0b._.js.map