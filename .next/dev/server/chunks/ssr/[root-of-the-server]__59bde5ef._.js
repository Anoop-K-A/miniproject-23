...
function SignInForm({ onLogin, onSignInSuccess, onSwitchToSignUp }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["auth"], formData.email, formData.password);
            // Get ID token
            ...
            if (!response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.error || `Login failed (HTTP ${response.status})`);
                setIsLoading(false);
                return;
            }
            const data = await response.json();
            ...
            if (error.code === "auth/user-not-found") {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid password");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Account pending admin approval");
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "An error occurred during login");
            }
        } finally{
            setIsLoading(false);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59bde5ef._.js.map