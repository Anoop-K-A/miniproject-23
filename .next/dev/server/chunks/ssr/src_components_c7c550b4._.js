...
function AdminDashboard() {
    ...
    const fetchUsers = async ()=>{
        try {
            ...
            if (!usersResponse.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(usersData.error || "Failed to load users");
                return;
            }
    ...
    const handleRoleChange = async (userId, newRole)=>{
        ...
        if (updated) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Role updated to ${ROLE_LABELS[newRole]}`);
...
//# sourceMappingURL=src_components_c7c550b4._.js.map